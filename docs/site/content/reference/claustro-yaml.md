...
| `voice` | bool | false | SoX + audio libraries for Claude Code `/voice` command (opt-in). **Note:** voice mode does not currently work inside containers due to lack of host microphone access. |
